...
// This file was auto-generated with sscapigen based on SscApiModelDirect.cs, hash pg5nTBhNWCAC+dny0t1kjQ==
//
...
namespace Microsoft::Azure::SpatialAnchors
{
    ...
    runtime_error& operator=(runtime_error&&) = default;
        ...
        runtime_error(Status const status) noexcept : m_status(status)
        {
        }
